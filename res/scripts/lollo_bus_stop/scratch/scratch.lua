...
moduleHelpers.setIntParamsFromFloat(params, 'aa5', 'ab5', 1000.0000000001)
local test5 = moduleHelpers.getFloatFromIntParams(params, 'aa5', 'ab5')

moduleHelpers.setIntParamsFromFloat(params, 'aa6', 'ab6', -1000.0000000001)
local test6 = moduleHelpers.getFloatFromIntParams(params, 'aa6', 'ab6')

moduleHelpers.setIntParamsFromFloat(params, 'aa7', 'ab7', 1000.000000000000001)
local test7 = moduleHelpers.getFloatFromIntParams(params, 'aa7', 'ab7')

moduleHelpers.setIntParamsFromFloat(params, 'aa8', 'ab8', -1000.000000000000001)
local test8 = moduleHelpers.getFloatFromIntParams(params, 'aa8', 'ab8')

moduleHelpers.setIntParamsFromFloat(params, 'aa9', 'ab9', 0.00000000000001)
local test9 = moduleHelpers.getFloatFromIntParams(params, 'aa9', 'ab9')

moduleHelpers.setIntParamsFromFloat(params, 'aa10', 'ab10', -0.00000000000001)
local test10 = moduleHelpers.getFloatFromIntParams(params, 'aa10', 'ab10')

moduleHelpers.setIntParamsFromFloat(params, 'aa11', 'ab11', 1000.000000000000001)
local test11 = moduleHelpers.getFloatFromIntParams(params, 'aa11', 'ab11')

moduleHelpers.setIntParamsFromFloat(params, 'aa12', 'ab12', -1000.000000000000001)
